...
export const MOCK_PROYECTOS: Proyecto[] = [
  {
    ...
    dv: '8',
    correoFacturas: 'facturas@elroble.co',
    correoFacturasConectado: true,
    correoDian: 'gerencia@elroble.co',
    correoDianConectado: true,
  ...
  },
  {
    ...
    dv: '3',
    correoFacturas: 'facturas.maracay@gmail.com',
    correoFacturasConectado: true,
    correoDian: 'facturas.maracay@gmail.com',
